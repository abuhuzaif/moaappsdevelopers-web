...
export default function PrivacyPage() {
  return (
    <>
      ...
      <main className="container" style={{ maxWidth: 760, padding: "32px 24px 80px" }}>
        <a
          href="/ksa-connect"
          style={{ fontSize: 13.5, fontWeight: 700, color: "var(--text-muted)", display: "inline-block", marginBottom: 16 }}
        >
          ← Back to KSA-Connect
        </a>
